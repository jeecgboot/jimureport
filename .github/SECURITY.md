...
Security fixes are generally provided for the latest released version of JimuReport. Please upgrade to the latest release before reporting an issue that may already have been fixed.

JimuReport 原则上仅为最新正式版本提供安全修复。报告可能已经修复的问题前，请先升级到最新版本进行确认。
...
Please report suspected security vulnerabilities through [GitHub Private Vulnerability Reporting](https://github.com/jeecgboot/JimuReport/security/advisories/new).

如发现疑似安全漏洞，请通过 [GitHub 私密漏洞报告](https://github.com/jeecgboot/JimuReport/security/advisories/new) 提交。
...
- Affected JimuReport version, branch, and deployment mode
...
Thank you for helping keep JimuReport and its users secure.

感谢你帮助 JimuReport 及其用户提升安全性。
